...
* Wait for a reviewer on its completion notice. Wait for a long command with a tool that watches the command's exit or its own output. Never wait on a timer, or on text you wrote.
